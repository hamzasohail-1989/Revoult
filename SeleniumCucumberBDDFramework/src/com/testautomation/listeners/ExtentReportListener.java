...
public class ExtentReportListener{
	...
	public static ExtentReports setUp() {
		...
		report.config().setDocumentTitle("Revoult Assignement Test Report");
		report.config().setReportName("Revoult Assignement Test Report");
		...
		extent.setSystemInfo("Application", "Revoult.com");
